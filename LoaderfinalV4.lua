...
-- [Lanjutkan semua GUI & Toggle system sama persis dengan scriptmu]

-- Pastikan **tidak ada loadstring([[ ... ]])()** di awal
-- Jika ingin menjalankan script utama via GitHub:
-- loadstring(game:HttpGet("https://raw.githubusercontent.com/username/repo/branch/LoaderFinalV4.lua"))()
