--// Loader Final Versi 4 - SuttannHub (GitHub-Safe Version)
...
local function SafeHttpGet(url)
    ...
    if success then
        ...
        warn("Gagal ambil data dari "..url)
        return ""
    end
end
...
local function GetPastebinRaw(paste_id)
    return SafeHttpGet("https://pastebin.com/raw/"..paste_id)
end
...
local function OpenMainGUI()
    ...
    -- External features (SafeHttpGet dipakai)
    AddToggle("Name", function(state) if state then pcall(function() loadstring(SafeHttpGet('https://pastebin.com/raw/SDSsfiVN'))() end) end end)
    AddToggle("Show Guns", function(state) if state then pcall(function() loadstring(SafeHttpGet("https://raw.githubusercontent.com/hellmid122/script-0x391/main/guns"))() end) end end)
    AddToggle("Health", function(state) if state then pcall(function() loadstring(SafeHttpGet('https://pastebin.com/raw/mxLC8P1L'))() end) end end)
    AddToggle("Distance", function(state) if state then pcall(function() loadstring(SafeHttpGet('https://pastebin.com/raw/nDnBxSyZ'))() end) end end)
    AddToggle("Skeleton", function(state) if state then pcall(function() loadstring(SafeHttpGet("https://raw.githubusercontent.com/melvin123gp/shit/refs/heads/main/skeleto"))() end) end end)
    AddToggle("Cham", function(state) if state then pcall(function() loadstring(SafeHttpGet("https://raw.githubusercontent.com/melvin123gp/e21/refs/heads/main/111"))() end) end end)
    ...
    -- Jalankan script utama SuttannHubV3 (Safe)
    pcall(function()
        loadstring(SafeHttpGet("https://raw.githubusercontent.com/Mereeeecuf/Scriptbro/refs/heads/main/SuttannHubV3"))()
    end)
end

-- Cek apakah sudah ada file key (Safe pcall)
local savedKey = nil
pcall(function()
